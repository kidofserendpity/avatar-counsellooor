...
const VISUAL_FACT_PROMPT = `You're looking at a photo someone shared with an AI companion, possibly with a short caption. Write ONE short, plain, respectful factual description that could help recall who or what was in the photo later — for a person: general appearance (hair, approximate age range, notable features, expression), described plainly, never evaluated or judged. For anything else, the key subject of the photo. If the caption makes clear who this person is to the user (e.g. someone they've mentioned), include that briefly. Under 25 words, third person, description only — no commentary. Respond with only the description.`;
